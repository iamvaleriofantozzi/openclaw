...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["sessions.list", "sessions", "operator.read", "<=2026.7", { startup: true }],
  ["sessions.subscribe", "sessions", "operator.read", "<=2026.7"],
  ["sessions.unsubscribe", "sessions", "operator.read", "<=2026.7"],
  ["sessions.messages.subscribe", "sessions", "operator.read", "<=2026.7"],
  ["sessions.messages.unsubscribe", "sessions", "operator.read", "<=2026.7"],
  ["sessions.viewers.set", "sessions", "operator.read", "2026.7"],
  ["sessions.preview", "sessions", "operator.read", "<=2026.7"],
  ["sessions.describe", "sessions", "operator.read", "<=2026.7"],
  ["sessions.compaction.list", "sessions", "operator.read", "<=2026.7"],
  ["sessions.compaction.get", "sessions", "operator.read", "<=2026.7"],
  ["sessions.compaction.branch", "sessions", "operator.write", "<=2026.7"],
  ["sessions.compaction.restore", "sessions", "operator.admin", "<=2026.7"],
  ["sessions.branches.list", "sessions", "operator.read", "<=2026.7"],
  ["sessions.branches.switch", "sessions", "operator.admin", "<=2026.7"],
  ["sessions.rewind", "sessions", "operator.admin", "<=2026.7"],
  ["sessions.fork", "sessions", "operator.write", "<=2026.7"],
  // Params-aware: explicit cwd can point at any host checkout and requires admin.
  ["sessions.create", "sessions", "dynamic", "<=2026.7", { startup: true }],
  ["sessions.send", "sessions", "operator.write", "<=2026.7", { startup: true }],
  ["sessions.abort", "sessions", "operator.write", "<=2026.7", { startup: true }],
  ...
  ["sessions.patch", "sessions", "dynamic", "<=2026.7"],
  ["sessions.pluginPatch", "sessions", "operator.admin", "<=2026.7"],
  ["sessions.cleanup", "sessions", "operator.admin", "<=2026.7"],
  ["sessions.reset", "sessions", "operator.admin", "<=2026.7"],
  ...
  ["sessions.delete", "sessions", "dynamic", "<=2026.7"],
  ["sessions.compact", "sessions", "operator.admin", "<=2026.7"],
  ["sessions.groups.list", "sessions", "operator.read", "<=2026.7"],
  ["sessions.groups.put", "sessions", "operator.write", "<=2026.7"],
  ["sessions.groups.rename", "sessions", "operator.write", "<=2026.7"],
  ["sessions.groups.delete", "sessions", "operator.write", "<=2026.7"],
  ...
  ["sessions.get", "sessions", "operator.read", "<=2026.7", { advertise: false }],
  ["sessions.resolve", "sessions", "operator.read", "<=2026.7", { advertise: false }],
  ...
  ["sessions.steer", "sessions", "operator.write", "<=2026.7", { advertise: false }],
  ...
  ["sessions.search", "sessions", "operator.read", "<=2026.7"],
  [
    "sessions.dispatch",
    "sessions",
    "operator.admin",
  ...
  ["session.visibility.set", "sessions", "operator.write", "2026.7"],
  ["session.members.list", "sessions", "operator.read", "2026.7"],
  ["session.members.add", "sessions", "operator.write", "2026.7"],
  ["session.members.remove", "sessions", "operator.write", "2026.7"],
  ["session.suggestions.add", "sessions", "operator.write", "2026.7"],
  ["session.suggestions.list", "sessions", "operator.read", "2026.7"],
  ["session.suggestions.resolve", "sessions", "operator.write", "2026.7"],
  ["session.typing", "sessions", "operator.write", "2026.7"],
