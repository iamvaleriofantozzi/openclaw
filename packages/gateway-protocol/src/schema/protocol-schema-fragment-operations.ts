...
export const OperationsProtocolSchemas = {
  ...
  SystemAgentChatQuestionOption: openclaw.SystemAgentChatQuestionOptionSchema,
  SystemAgentChatAcknowledgementQuestion: openclaw.SystemAgentChatAcknowledgementQuestionSchema,
  SystemAgentChatPresentation: openclaw.SystemAgentChatPresentationSchema,
